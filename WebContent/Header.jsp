				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item ${EtudOpen} ${AllEtud} ${AddEtud} ">
								<a href="#" class="nav-link nav-toggle"><i class="material-icons">group</i>
									<span class="title">Etudiants</span><span class="arrow ${EtudOpen}"></span></a>
								<ul class="sub-menu">
									<li class="nav-item ${AllEtud }">
										<a href="listEtud" class="nav-link "> <span class="title">Tous les Etudiants</span>
										</a>
									</li>
									<li class="nav-item ${AddEtud}">
										<a href="ajouterEtud" class="nav-link "> <span class="title">Ajouter un Etudiant</span>
										</a>
									</li>
